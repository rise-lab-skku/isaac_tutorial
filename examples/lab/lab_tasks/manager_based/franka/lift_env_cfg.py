...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    contact_forces = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/panda_.*finger", update_period=0.0, history_length=6, debug_vis=True, track_air_time=True
    )
...
class RewardsCfg:
    ...
    reaching_object = RewTerm(func=mdp.object_ee_distance, params={"threshold": 0.1}, weight=1.0)
    
    # 2. Grasp the object
    force_closure_grasping = RewTerm(func=mdp.force_closure, weight=5.0)
