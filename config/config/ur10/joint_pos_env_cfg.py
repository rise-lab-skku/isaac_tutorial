...
from omni.isaac.lab_assets import UR10_CFG, BARRETT_CFG, EZGRIPPER_CFG
...
class UR10CubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        # Set Gripper
        self.scene.gripper = BARRETT_CFG.replace(prim_path="{ENV_REGEX_NS}/Gripper")
        self.scene.gripper2 = EZGRIPPER_CFG.replace(prim_path="{ENV_REGEX_NS}/Gripper2")
        # Set the body name for the end effector
