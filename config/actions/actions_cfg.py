...
from . import binary_joint_actions, joint_actions, joint_actions_to_limits, non_holonomic_actions, task_space_actions, gripper_actions
...
@configclass
class BarrettHandJointControlCfg(BinaryJointActionCfg):
    """Configuration for the binary joint velocity action term.

    See :class:`BinaryJointVelocityAction` for more details.
    """
    mount_joint_num: int = 0
    palm_joint: float = 0.0
    class_type: type[ActionTerm] = gripper_actions.BarrettHandJointControl
